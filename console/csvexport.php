...
<html>
    ...
    <body onload="generateExportLink()">
        <select id="sortby" onchange="generateExportLink()">
        ...
        <select id="sortorder" onchange="generateExportLink()">
            <option value="ASC">Ascending</option>
            <option value="DESC">Descending</option>
        </select>
        <select id="filter" onChange="generateExportLink()">
        ...
        <p><a id="csvlink" href="javascript:void()">Generate CSV File</a></p>
    </body>
</html>
